...
[1] = KEYMAP(
    ...
    _______ , _______ , F(11)   , F(12)   , _______ , _______ , KC_RBRC ,
              F(15)   , F(9)    , F(10)   , _______ , M(1)    , KC_NUHS ,
    _______ , KC_SLSH , F(13)   , F(14)   , _______ , KC_PGUP , _______ ,
...
[2] = KEYMAP(  // Layer2:
        // left hand
        RESET   , KC_F1   , KC_F2   , KC_F3   , _______ , _______ , _______ ,
